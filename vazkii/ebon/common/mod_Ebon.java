...
@Mod(modid = "ebon_Vz", name = "The Ebon Mod", version = "by Vazkii. Version [4.0] for 1.3.2.") @NetworkMod(channels = { "ebon_Vz", "ebon1_Vz", "ebon2_Vz", "ebon3_Vz", "ebon4_Vz" }, packetHandler = EbonModPacketHandler.class, clientSideRequired = true) public class mod_Ebon {
	...
	public void onInit(FMLInitializationEvent event) {
		...
		GameRegistry.addRecipe(new ItemStack(ebonScepter), " SG", " BS", "E  ", Character.valueOf('G'), bloodGem, Character.valueOf('S'), demonicSoul, Character.valueOf('E'), ebonGem);
		GameRegistry.addShapelessRecipe(new ItemStack(bloodPowder), soulGrindstone, bloodGem);
		...
		GameRegistry.addRecipe(new ItemStack(necromancerLexicon), "PEP", "EBE", "PEP", Character.valueOf('P'), bloodPowder, Character.valueOf('E'), Item.writtenBook, Character.valueOf('E'), undeadEssence);
		GameRegistry.addRecipe(new ItemStack(necromancerLexicon), "EPE", "PBP", "EPE", Character.valueOf('P'), bloodPowder, Character.valueOf('E'), Item.writtenBook, Character.valueOf('E'), undeadEssence);
		...
		GameRegistry.addRecipe(new ItemStack(wandOfRetrieval), "  B", " S ", "B  ", Character.valueOf('B'), bloodGem, Character.valueOf('S'), soulStone, Character.valueOf('B'), Item.blazeRod);
		...
		GameRegistry.addRecipe(new ItemStack(plusiumCharm), "PSS", "BMS", "BBS", Character.valueOf('P'), bloodPowder, Character.valueOf('S'), Item.silk, Character.valueOf('B'), bottleOfDarkness, Character.valueOf('M'), ebonGlowstone);
		GameRegistry.addRecipe(new ItemStack(miniumCharm), "PSS", "BMS", "BBS", Character.valueOf('P'), bloodPowder, Character.valueOf('S'), Item.silk, Character.valueOf('B'), bottleOfDarkness, Character.valueOf('M'), ebonObsidian);
		GameRegistry.addRecipe(new ItemStack(ebonCloth, 4), "SES", "SCS", "SES", Character.valueOf('S'), demonicSoul, Character.valueOf('E'), undeadEssence, Character.valueOf('C'), new ItemStack(Block.cloth, -1));
		GameRegistry.addRecipe(new ItemStack(ebonCloth, 4), "ESE", "ECE", "ESE", Character.valueOf('S'), demonicSoul, Character.valueOf('E'), undeadEssence, Character.valueOf('C'), new ItemStack(Block.cloth, -1));
