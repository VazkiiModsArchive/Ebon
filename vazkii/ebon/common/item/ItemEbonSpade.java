...
public class ItemEbonSpade extends ItemSpade {

	public ItemEbonSpade(int par1) {
	...
	public boolean onBlockDestroyed(ItemStack par1ItemStack, World par2World, int par3, int par4, int par5, int par6, EntityLiving par7EntityLiving) {
		...
		if (Arrays.asList(blocksEffectiveAgainst).contains(block) && random.nextInt(50) == 0 && !EbonModHelper.doesPlayerHaveME(par7EntityLiving)) {
			...
			CommonUtils.sendChatMessage((EntityPlayer) par7EntityLiving, "I seem to have found some Corpse Dust.");
			par7EntityLiving.dropItem(mod_Ebon.corpseDust.shiftedIndex, 1);
