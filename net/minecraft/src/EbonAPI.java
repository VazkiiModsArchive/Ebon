...
public class EbonAPI
{
    ...
    /**
     * The List of spawners that are blacklisted from Wands of Retrieval and Imprisonment.
     */
    public static List<String> blacklistedSpawners = new LinkedList();
    ...
    public static void addMagicalExhaustionOnPlayerFor(int time)
    {
        ...
        if (doesPlayerHaveMagicExhaustion())
        {
            return;
        }
    ...
    /**
     * Used to blacklist a spawner from being retrieved by the Wand of Retrieval and by being
     * placed by the Wand of Imprisionment.
     *
     * @param name The Name of the entity to blacklist.
     */
    public static void blacklistSpawner(String name)
    {
        if (!blacklistedSpawners.contains(name))
        {
            blacklistedSpawners.add(name);
        }
    }
}
