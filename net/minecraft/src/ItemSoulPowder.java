...
public class ItemSoulPowder extends ItemEbonMod
{
    ...
    public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer)
    {
        ...
        if(j > 95)
        {
            ...
            world.playSoundAtEntity(entityplayer, "vazkii.ebonmod.spRare", 0.5F, 0.4F / (itemRand.nextFloat() * 0.4F + 0.8F));
        } else
        if(j > 90)
        {
        ...
        world.playSoundAtEntity(entityplayer, "vazkii.ebonmod.spNormal", 0.5F, 0.4F / (itemRand.nextFloat() * 0.4F + 0.8F));
        } else
        if(j > 80)
        {
